 ...
 * @since 19/10/2023
 */
public class PropagatorCumulativeWithBacktrackable extends PropagatorResource {
    ...
    public PropagatorCumulativeWithBacktrackable(Task[] tasks, IntVar[] heights, IntVar capacity) {
